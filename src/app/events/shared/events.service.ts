...
export class EventsService{
    ...
    getEvents():Observable<IEvent[]|unknown>{
      return this.http.get<IEvent[]|undefined>('api/events')
      .pipe(
        catchError(this.handleError<IEvent[]>('getEvents', []))
      );
    }

    getEvent(id:number):Observable<IEvent|unknown>|undefined{
      return this.http.get<IEvent[] | undefined>('/api/events/'+id)
